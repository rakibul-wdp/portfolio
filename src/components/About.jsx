...
const About = () => {
  return (
    <div className='col-span-3 mt-36'>
      ...
      <h2 className='text-2xl text-[#5ff3d1]'>Full Stack Developer</h2>
      <h2 className='text-2xl text-[#5ff3d1]'>Programmer and</h2>
      <h2 className='text-2xl text-[#5ff3d1]'>Problem Solver</h2>
