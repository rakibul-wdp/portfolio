  ...
  return (
    <div className='col-span-3 mt-36'>
      ...
      <div className='text-center'>
        <h2 className='text-2xl text-start text-[#5ff3d1]'>Full Stack Developer</h2>
